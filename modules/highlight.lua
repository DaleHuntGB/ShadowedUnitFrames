local Highlight = {}
local goldColor, mouseColor = {r = 0.75, g = 0.75, b = 0.35}, {r = 1.00, g = 1.00, b = 1.00}
...
function Highlight:OnEnable(frame)
	...
	if( not frame.highlight ) then
		...
		frame.highlight.top:SetBlendMode("BLEND")
		frame.highlight.top:SetTexture("Interface\\Buttons\\WHITE8X8")
		frame.highlight.top:SetPoint("TOPLEFT", frame, 1, -1)
		frame.highlight.top:SetPoint("TOPRIGHT", frame, -1, 1)
		...
		frame.highlight.left:SetBlendMode("BLEND")
		frame.highlight.left:SetTexture("Interface\\Buttons\\WHITE8X8")
		frame.highlight.left:SetPoint("TOPLEFT", frame, 1, -1)
		frame.highlight.left:SetPoint("BOTTOMLEFT", frame, -1, 1)
		...
		frame.highlight.right:SetBlendMode("BLEND")
		frame.highlight.right:SetTexture("Interface\\Buttons\\WHITE8X8")
		frame.highlight.right:SetPoint("TOPRIGHT", frame, -1, -1)
		frame.highlight.right:SetPoint("BOTTOMRIGHT", frame, 0, 1)
		...
		frame.highlight.bottom:SetBlendMode("BLEND")
		frame.highlight.bottom:SetTexture("Interface\\Buttons\\WHITE8X8")
		frame.highlight.bottom:SetPoint("BOTTOMLEFT", frame, 1, 1)
		frame.highlight.bottom:SetPoint("BOTTOMRIGHT", frame, -1, 1)
